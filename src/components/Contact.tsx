      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto font-light">
            Do you have a project in mind? I'd be interested in hearing your
            proposal and exploring how we can collaborate.
          </p>
        </div>
          ...
          <div className="space-y-6">
            <div className="grid lg:grid-cols-2 gap-4 items-start">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">github.com/osva</p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">linkedin.com/in/osva</p>
                </div>
              </a>
            ...
            <div className="p-6 bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg">
              <blockquote className="text-gray-300 leading-relaxed">
                "Software development requires the same precision and patience
                as observing the cosmos: attention to detail and a long-term
                vision."
              </blockquote>
