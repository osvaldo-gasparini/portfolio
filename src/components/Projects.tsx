...
const Projects: React.FC = () => {
  const projects = [
    ...
    },
    {
      ...
      description:
        "App móvil para gestión financiera con autenticación segura y sincronización en tiempo real.",
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto font-light">
            Selection of projects that demonstrate experience in full-stack
            development
          </p>
        </div>
